...
- [x] 1.1 Finalize proposal scope and acceptance criteria for `agent-codex-setup-protected-main-sandbox-2026-04-21-12-02`.
...
- [x] 3.2 Run `openspec validate agent-codex-setup-protected-main-sandbox-2026-04-21-12-02 --type change --strict`.
